...
#  http://logstash.net/docs/1.2.2.dev/outputs/redis
#
...
define logstash::output::redis (
  ...
  file { $conffiles:
    ...
    content => "output {\n redis {\n${opt_batch}${opt_batch_events}${opt_batch_timeout}${opt_codec}${opt_congestion_interval}${opt_congestion_threshold}${opt_data_type}${opt_db}${opt_host}${opt_key}${opt_password}${opt_port}${opt_reconnect_interval}${opt_shuffle_hosts}${opt_timeout} }\n}\n",
    mode    => '0440',
