...
#   once we switch away from doing 'readline' Command to run and read
#   events from, one line at a time.  Example:     command =&gt; "echo
#   hello world"
...
#  http://logstash.net/docs/1.2.2.dev/inputs/pipe
#
...
define logstash::input::pipe (
  ...
  file { $conffiles:
    ...
    content => "input {\n pipe {\n${opt_add_field}${opt_codec}${opt_command}${opt_debug}${opt_tags}${opt_type} }\n}\n",
    mode    => '0440',
