...
#  http://logstash.net/docs/1.2.2.dev/inputs/syslog
#
...
define logstash::input::syslog (
  ...
  file { $conffiles:
    ...
    content => "input {\n syslog {\n${opt_add_field}${opt_codec}${opt_debug}${opt_facility_labels}${opt_host}${opt_port}${opt_severity_labels}${opt_tags}${opt_type}${opt_use_labels} }\n}\n",
    mode    => '0440',
