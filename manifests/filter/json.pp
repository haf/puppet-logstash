...
#   %{field} Example:  filter {   json {     remove_field =&gt; [
#   "foo_%{somefield}" ]   } }   If the event has field "somefield" ==
...
#   =&gt; "message"   } }   The above would parse the json from the
#   @message field
...
#
# [*target*]
#   Define target for placing the data. If this setting is omitted, the
#   json data will be stored at the root of the event.  For example if you
#   want the data to be put in the 'doc' field:  filter {   json {
#   target =&gt; "doc"   } }   json in the value of the source field will
#   be expanded into a datastructure in the "target" field.  Note: if the
#   "target" field already exists, it will be overwritten.
#   Value type is string
#   Default value: None
#   This variable is optional
#
...
#  http://logstash.net/docs/1.2.2.dev/filters/json
#
